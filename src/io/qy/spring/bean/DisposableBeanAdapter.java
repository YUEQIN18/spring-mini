...
public class DisposableBeanAdapter implements DisposableBean{
    ...
    public DisposableBeanAdapter(Object bean, String beanName, MyBeanDefinition beanDefinition) {
        this.bean = bean;
        this.beanName = beanName;
        this.beanDefinition = beanDefinition;
    }

    public static boolean hasDestroyMethod(Object bean, MyBeanDefinition beanDefinition) {
